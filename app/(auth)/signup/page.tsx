...
export const metadata: Metadata = {
    title: `Sign up - ${AppSettings.SITE_NAME}`,
    ...
    return (
        <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center dark:bg-[#121212] relative">
            ...
            <div className="max-w-md w-full p-6">
                ...
                <h1 className="text-2xl font-extraboldtext-black text-start dark:text-white mt-2">Signup for a new account</h1>
                <p className="text-sm text-gray-500  mb-6">You are required to use your work email (eg yourname@oceanoftechsa.com).</p>

                {/** login form **/}
                <AuthForm BtnIcon={<IoPersonAddSharp />} variant="signup" />
            </div>
